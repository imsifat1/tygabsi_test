            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(!ready ? 'Ready to calculate' : 'Final Result',
                        style: Theme.of(context)
                            .textTheme
                            .labelLarge
                            ?.copyWith(fontWeight: FontWeight.w700)),
                    // const SizedBox(height: 6),
                    Text(!ready ? 'Fasting TG, Glucose, Weight, Height, Waist' : 'TyG Index × ABSI',
              ...
              AnimatedSwitcher(
                ...
                child: Text(
                  value,
                  key: ValueKey(value),
                  style: TextStyle(fontWeight: FontWeight.w800, letterSpacing: -0.2, fontSize: ready ? 30 : 15),
                ),
              ),
            ],
          ),
